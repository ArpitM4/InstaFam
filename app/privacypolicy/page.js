...
export default function PrivacyPolicy() {
  return (
    <div className="min-h-screen bg-background text-text py-16 px-6">
      <div className="max-w-5xl mx-auto">
        <h1 className="text-5xl font-bold text-center text-primary mb-10">
          Privacy Policy
        </h1>
        <p className="text-center text-text/60 text-lg max-w-3xl mx-auto mb-8">
          Last updated on <span className="text-text">06-02-2025</span>
        </p>

        <p className="text-lg text-text/80 mb-8 text-center max-w-3xl mx-auto">
          Your privacy is critically important to us at <span className="font-bold text-text">InstaFam</span>. This Privacy Policy outlines how we collect, use, and protect your personal information when you use our platform.
        </p>

        {/* Section 1 */}
        <div className="mt-12">
          <h2 className="text-3xl font-semibold text-accent mb-4">1. Information We Collect</h2>
          <ul className="list-disc list-inside text-text/90 space-y-4 pl-4">
            <li>
        ...
        {/* Section 2 */}
        <div className="mt-12">
          <h2 className="text-3xl font-semibold text-accent mb-4">2. How We Use Your Information</h2>
          <ul className="list-disc list-inside text-text/90 space-y-4 pl-4">
        ...
        {/* Section 3 */}
        <div className="mt-12">
          <h2 className="text-3xl font-semibold text-accent mb-4">3. Sharing Your Information</h2>
          ...
          <ul className="list-disc list-inside text-text/90 mt-2 space-y-2 pl-4">
        ...
        {/* Section 4 */}
        <div className="mt-12">
          <h2 className="text-3xl font-semibold text-accent mb-4">4. Data Security</h2>
          <p className="text-text/80">
        ...
        {/* Section 5 */}
        <div className="mt-12">
          <h2 className="text-3xl font-semibold text-accent mb-4">5. Your Rights</h2>
          ...
          <p className="text-text/80 mt-4">
            Email us at <a href="mailto:support@instafam.social" className="underline text-secondary">support@instafam.social</a> for any requests.
          </p>
        </div>

        {/* Section 6 */}
        <div className="mt-12">
          <h2 className="text-3xl font-semibold text-accent mb-4">6. Cookies</h2>
          <p className="text-text/80">
        ...
        {/* Section 7 */}
        <div className="mt-12">
          <h2 className="text-3xl font-semibold text-accent mb-4">7. Policy Updates</h2>
          <p className="text-text/80">
        ...
        {/* Section 8 */}
        <div className="mt-12">
          <h2 className="text-3xl font-semibold text-accent mb-4">8. Contact Us</h2>
          <p className="text-text/80">
            Legal Entity: <strong>ARPIT MAURYA</strong><br />
            Email: <a href="mailto:support@instafam.social" className="underline text-secondary">support@instafam.social</a><br />
            Phone: <a href="tel:+917982432872" className="underline text-secondary">+91 7982432872</a><br />
