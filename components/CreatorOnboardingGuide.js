...
const CreatorOnboardingGuide = ({
    ...
    if (!isExpanded) {
        return (
            <button
                ...
                className="fixed bottom-6 right-6 z-[9990] flex items-center gap-3 px-4 py-3 rounded-full shadow-2xl hover:scale-105 transition-transform"
                style={{
    ...
    return (
        <div className="fixed bottom-6 right-6 z-[9990] w-72 animate-fadeIn">
            <div
